...
def get_esg(ticker_name):
    esg_data_mapping = {
        "RELIANCE.NS": "https://www.sustainalytics.com/esg-rating/reliance-industries-ltd/1008756619"
    }
    if ticker_name not in esg_data_mapping:
    ...
    if not os.path.exists(f"data/esg/{ticker_name}.json"):
        ...
        esg_data = scrape_esg_sustainalytics(esg_data_mapping[ticker_name])
